...
# Generate a list of subprojects from bazel
message(STATUS "Generating package list...")
set(DASHBOARD_BAZEL_PACKAGE_LIST "${CTEST_BINARY_DIRECTORY}/package_list.txt")
execute_process(
    COMMAND ${DASHBOARD_BAZEL_COMMAND} query '//...' --output package --keep_going
    WORKING_DIRECTORY ${DASHBOARD_SOURCE_DIRECTORY}
    OUTPUT_FILE ${DASHBOARD_BAZEL_PACKAGE_LIST})

ctest_submit(PARTS Update RETRY_COUNT 4 RETRY_DELAY 15 QUIET)
ctest_submit(CDASH_UPLOAD "${DASHBOARD_BAZEL_PACKAGE_LIST}"
  CDASH_UPLOAD_TYPE SubProjectDirectories
