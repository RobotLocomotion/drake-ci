...
set(CTEST_BUILD_COMMAND
  "${DASHBOARD_BAZEL_COMMAND} ${DASHBOARD_BAZEL_STARTUP_OPTIONS} test -s ${DASHBOARD_BAZEL_BUILD_OPTIONS} ${DASHBOARD_BAZEL_TEST_OPTIONS} ${DASHBOARD_BUILD_EVENT_OPTION} ...")
#  "${DASHBOARD_BAZEL_COMMAND} ${DASHBOARD_BAZEL_STARTUP_OPTIONS} test ${DASHBOARD_BAZEL_BUILD_OPTIONS} ${DASHBOARD_BAZEL_TEST_OPTIONS} ${DASHBOARD_BUILD_EVENT_OPTION} common:polynomial_test manipulation/util:frame_pose_tracker_test manipulation/util:sim_diagram_builder_test")
...
if(COVERAGE)
  ...
  file(READ "${KCOV_MERGED}/cobertura.xml" COBERTURA_CONTENT)
  file(WRITE "${KCOV_MERGED}/coverage.xml" "${COBERTURA_CONTENT}")
