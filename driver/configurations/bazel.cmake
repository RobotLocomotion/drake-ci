...
if(REMOTE_CACHE)
  set(DASHBOARD_REMOTE_HTTP_CACHE_URL "http://172.31.30.116")
  ...
  file(REMOVE "${DASHBOARD_FILE_DOWNLOAD_TEMP}")
  if(DASHBOARD_DOWNLOAD_STATUS_0 EQUAL 0)
    set(DASHBOARD_BAZEL_BUILD_OPTIONS "${DASHBOARD_BAZEL_BUILD_OPTIONS} --experimental_remote_spawn_cache --remote_http_cache=${DASHBOARD_REMOTE_HTTP_CACHE_URL}")
    if(APPLE)
