...
ctest_build(BUILD "${CTEST_BINARY_DIRECTORY}" APPEND
  ...
  CAPTURE_CMAKE_ERROR DASHBOARD_SUPERBUILD_BUILD_RETURN_VALUE QUIET)
...
# Run tests
if(DASHBOARD_TEST)
  # TODO: Work out why CAPTURE_CMAKE_ERROR and RETURN_VALUE are returning
  # different values.
  ctest_test(BUILD "${CTEST_BINARY_DIRECTORY}" ${CTEST_TEST_ARGS}
    CAPTURE_CMAKE_ERROR DASHBOARD_SUPERBUILD_TEST_CAPTURE_CMAKE_ERROR
