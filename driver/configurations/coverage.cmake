...
if(COMPILER STREQUAL "clang")
  if(APPLE)
    ...
    find_program(DASHBOARD_COVERAGE_COMMAND NAMES "llvm-cov${DASHBOARD_CLANG_COMPILER_SUFFIX}" llvm-cov)
  endif()
  if(NOT DASHBOARD_COVERAGE_COMMAND)
    fatal("llvm-cov${DASHBOARD_CLANG_COMPILER_SUFFIX} was not found")
  endif()
  set(DASHBOARD_COVERAGE_EXTRA_FLAGS "gcov")
elseif(COMPILER STREQUAL "gcc")
  find_program(DASHBOARD_COVERAGE_COMMAND NAMES "gcov${DASHBOARD_GNU_COMPILER_SUFFIX}" gcov)
  if(NOT DASHBOARD_COVERAGE_COMMAND)
