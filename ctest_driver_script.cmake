...
if(DASHBOARD_CONFIGURATION_TYPE STREQUAL "Debug")
  set(DASHBOARD_TEST_TIMEOUT 1800)
endif()

if(MATLAB)
   math(EXPR DASHBOARD_TEST_TIMEOUT "${DASHBOARD_TEST_TIMEOUT} + 300")
endif()
...
set(DASHBOARD_WITH_CMAKE ON)
set(DASHBOARD_WITH_DIRECTOR OFF)
set(DASHBOARD_WITH_DRAKE ON)
set(DASHBOARD_WITH_DREAL ON)
set(DASHBOARD_WITH_EIGEN ON)
set(DASHBOARD_WITH_GFLAGS ON)
...
if(COMPILER STREQUAL "cpplint")
  ...
  set(DASHBOARD_WITH_CMAKE OFF)
  set(DASHBOARD_WITH_DRAKE OFF)
  set(DASHBOARD_WITH_DREAL OFF)
  set(DASHBOARD_WITH_EIGEN OFF)
  set(DASHBOARD_WITH_GFLAGS OFF)
  set(DASHBOARD_WITH_GOOGLETEST OFF)
  set(DASHBOARD_WITH_LCM OFF)
  set(DASHBOARD_WITH_SPDLOG OFF)
...
set(CACHE_WITH_CMAKE "WITH_CMAKE:BOOL=${DASHBOARD_WITH_CMAKE}")
set(CACHE_WITH_DIRECTOR "WITH_DIRECTOR:BOOL=${DASHBOARD_WITH_DIRECTOR}")
set(CACHE_WITH_DRAKE "WITH_DRAKE:BOOL=${DASHBOARD_WITH_DRAKE}")
set(CACHE_WITH_DREAL "WITH_DREAL:BOOL=${DASHBOARD_WITH_DREAL}")
set(CACHE_WITH_EIGEN "WITH_EIGEN:BOOL=${DASHBOARD_WITH_EIGEN}")
set(CACHE_WITH_GFLAGS "WITH_GFLAGS:BOOL=${DASHBOARD_WITH_GFLAGS}")
...
set(CACHE_WITH_IPOPT "WITH_IPOPT:BOOL=${DASHBOARD_WITH_IPOPT}")
...
set(CACHE_WITH_SPDLOG "WITH_SPDLOG:BOOL=${DASHBOARD_WITH_SPDLOG}")
...
message("
  ...
  ctest_submit(PARTS Update RETRY_COUNT 3 RETRY_DELAY 10
...
${CACHE_WITH_YAML_CPP}
  ...
  ctest_submit(PARTS Configure RETRY_COUNT 3 RETRY_DELAY 10
    RETURN_VALUE DASHBOARD_SUPERBUILD_SUBMIT_RETURN_VALUE QUIET)
  ...
  ctest_submit(PARTS Build RETRY_COUNT 3 RETRY_DELAY 10
    RETURN_VALUE DASHBOARD_SUPERBUILD_SUBMIT_RETURN_VALUE QUIET)
  ...
  ctest_submit(PARTS Upload RETRY_COUNT 3 RETRY_DELAY 10
    RETURN_VALUE DASHBOARD_SUPERBUILD_SUBMIT_RETURN_VALUE QUIET)
