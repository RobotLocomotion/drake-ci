...
if($ENV{ros} AND EXISTS "/opt/ros/indigo/setup.bash")
...
if(NOT $ENV{openSource} AND NOT "$ENV{compiler}" MATCHES "cpplint")
  if(WIN32)
...
if("$ENV{memcheck}" MATCHES "^([amt]san|valgrind)$")
  ...
  elseif("$ENV{memcheck}" STREQUAL "msan")
    ...
    set(DASHBOARD_SHARED_LINKER_FLAGS
      "${DASHBOARD_SANITIZE_FLAGS} ${DASHBOARD_SHARED_LINKER_FLAGS}")
  elseif("$ENV{memcheck}" STREQUAL "tsan")
  ...
  elseif("$ENV{memcheck}" STREQUAL "valgrind")
...
if("$ENV{compiler}" MATCHES "msvc-ninja-32" AND $ENV{debug})
