...
if(MEMCHECK MATCHES "^([amt]san|valgrind)$")
  ...
  elseif(MEMCHECK STREQUAL "valgrind")
    ...
    set(CTEST_MEMORYCHECK_COMMAND_OPTIONS "--show-leak-kinds=definite,possible --trace-children=yes --trace-children-skip=/bin/*,/usr/bin/*,/usr/local/bin/*,/usr/local/MATLAB/*,${DASHBOARD_WORKSPACE}/build/install/bin/directorPython")
