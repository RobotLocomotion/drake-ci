...
set(CTEST_TEST_ARGS "")
if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/excluded_tests.txt")
  file(STRINGS "${CMAKE_CURRENT_LIST_DIR}/excluded_tests.txt" SKIP_TESTS)
  set(DASHBOARD_TEST_EXCLUDE_REGEX "|")
  foreach(test ${SKIP_TESTS} ${SKIP_TESTS_OSX})
    set(DASHBOARD_TEST_EXCLUDE_REGEX "${DASHBOARD_TEST_EXCLUDE_REGEX}${test}|")
  endforeach()
  set(CTEST_TEST_ARGS EXCLUDE \"${DASHBOARD_TEST_EXCLUDE_REGEX}\")
endif()
...
if(DASHBOARD_CONFIGURE_AND_BUILD_SUPERBUILD)
  # although wasteful, this way we can get warnings on the CDash dashboard
  # takes less than two minutes on my laptop as it is only Drake being built
  ctest_build(TARGET "clean" APPEND
    RETURN_VALUE DASHBOARD_CLEAN_RETURN_VALUE QUIET)
endif()
...
if(DASHBOARD_CONFIGURE_AND_BUILD_SUPERBUILD)
  ...
  if(NOT DASHBOARD_CLEAN_RETURN_VALUE EQUAL 0)
    set(DASHBOARD_FAILURE ON)
    list(APPEND DASHBOARD_FAILURES "CLEAN")
  endif()
endif()
